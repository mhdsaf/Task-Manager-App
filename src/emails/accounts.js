...
const welcomeEmail = (email, username, URL) => {
    var mailOptions = {
        ...
        text: `Hello ${username.toUpperCase()}. Welcome to Task Manager Application. We hope that you have an excellent experience using our platform! Please take a few minutes to verify your account: localhost:3000/users/verify/${URL} `
    };
...
const changePassword = (email, username, URL) => {
  var mailOptions = {
    ...
    You recently requested to change your password, and here is the link: localhost:3000/users/changepassword/${URL}
...
You recently requested to reset your password, and here is the link: localhost:3000/users/forgotpassword/${URL} . Note that this link is limited for a single use (you can access it once ONLY) and valid for 15 minutes.`
  };
